...
function init()
  ...
  params:add_control('_lpf_freq','lpf_freq',controlspec.new(100,20000,'lin',10,20000,'hz'))
  params:set_action('_lpf_freq', function(lpf_freq) engine.set_lpf_freq(lpf_freq) end)
  params:add_control('_lpf_q','lpf_q',controlspec.new(0.5,5,'lin',0.05,1,''))
  params:set_action('_lpf_q', function(lpf_q) engine.set_lpf_q(lpf_q) end)
